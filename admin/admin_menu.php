                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="../backEnd/manage_menu.php" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-outline mb-3 col-md-12">
                                                    ...
                                                    <input type="text" name="menu_name" class="form-control" minlength="3" value="<?php echo $row['menu_name'] ?>" required />
                                                </div>


                                                <div class="form-outline mb-3 col-md-12">
                                                    <label class="form-label" for="username">ราคา</label>
                                                    <input type="text" name="menu_price" id="username" class="form-control" value="<?php echo $row['menu_price'] ?>" required />
                                                </div>
