                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#myModal<?php echo $row["table_id"]; ?>"><?php echo $row["table_status"] ?></a>
                                </td>
                            </tr>

                            <!-- Modal -->
                            <div class="modal fade" id="myModal<?php echo $row["table_id"]; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="card">
                                                        ...
                                                        ?>
                                                            <div class="card-body">
                                                                <h5 class="card-title"><b>User ID :</b> <?php echo $row["user_id"]; ?></h5>
                                                                <p class="card-text"><b>User Name : </b> <?php echo $row["user_username"]; ?></p>
                                                                <p class="card-text"> <b>First Name :</b> <?php echo $row["user_fname"]; ?></p>
                                                                <p class="card-text"> <b>Last Name :</b> <?php echo $row["user_lname"] ?></p>
                                                            </div>
                                                        <?php
