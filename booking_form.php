                ...
                <form action="backEnd/query.php" method="post">
                    ...
                    <div class="form-group row cont-user">
                        ...
                        <div class="row mb-3">
                            <div class="form-outline mb-3 col-md-6">
                                ...
                                <input type="text" name="booking_firstname" id="booking_firstname" class="form-control"
                                       placeholder="กรอกชื่อของคุณ" minlength="3" pattern="[a-zA-Zก-๏\s]+" required/>
                            </div>

                            <div class="form-outline mb-3 col-md-6">
                                <label class="form-label">นามสกุล : </label>
                                <input type="text" name="booking_lastname" id="booking_lastname" class="form-control"
                                       placeholder="กรอกนามสกุลของคุณ" minlength="3" pattern="[a-zA-Zก-๏\s]+" required/>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" name="booking_phone" class="form-control" required
                                   placeholder="กรอกเบอร์โทร" minlength="10" maxlength="10" pattern="[0-9]{10}">
                        </div>
                    ...
                    <div class="form-group row cont-date mb-5">
                        <div class="mb-3 col-sm-4">
                            ...
                            <input type="date" name="booking_date" class="form-control" value="<?php
                            echo date('Y-m-d'); ?>" required readonly>
