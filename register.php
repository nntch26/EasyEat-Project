        ...
        <div class="content-regis">
            ...
            <form class="card card-cus" action="backEnd/login_system.php" method="post">
                ...
                <div class="form-outline mb-3">
                    ...
                    <input type="email" name="email" id="email" class="form-control" placeholder="กรอกอีเมลของคุณ"
                           required/>
                </div>
                ...
                <div class="form-outline mb-5">
                    ...
                    <input type="tel" name="phone" class="form-control" required placeholder="กรอกเบอร์โทร"
