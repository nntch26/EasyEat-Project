...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // bill_img แรก คือ ชื่อ ID, NAME ของที่เราตั้งใน FORM
    ...
    if ($uploadedFilename) {
        ...
        $insert_menu = $db->prepare("INSERT INTO Menus (menu_name, menu_price, menu_type, menu_pic) VALUES (:name, :price, :type, :img_name)");
...
// Example usage:
// handleImageUpload("bill_img", __DIR__ . "/bill_img");
